...
const CLIPS: Clip[] = [
  { id: 'stanley',  top: 64, left: 6,  width: 24, height: 28,
    labelKey: 'hotspot.stanley',  video: 'clip_01_stanley.mp4',
    endFrame: 'end_01_stanley.png',  subtitleKey: 'sub.stanley',
    affordance: 'ripple', affordanceX: 50, affordanceY: 50 },
  { id: 'polaroid', top: 64, left: 42, width: 18, height: 18,
    labelKey: 'hotspot.polaroid', video: 'clip_02_polaroid.mp4',
    endFrame: 'end_02_polaroid.png', subtitleKey: 'sub.polaroid',
    affordance: 'ripple', affordanceX: 50, affordanceY: 50 },
  { id: 'dollar',   top: 4,  left: 76, width: 22, height: 18,
    labelKey: 'hotspot.dollar',   video: 'clip_03_dollar.mp4',
    endFrame: 'end_03_dollar.png',   subtitleKey: 'sub.dollar',
    affordance: 'ripple', affordanceX: 50, affordanceY: 50 },
  { id: 'phone',    top: 80, left: 70, width: 22, height: 14,
    labelKey: 'hotspot.phone',    video: 'clip_04_phone.mp4',
    endFrame: 'end_04_phone.png',    subtitleKey: 'sub.phone',
    affordance: 'ripple', affordanceX: 50, affordanceY: 50 },
  { id: 'face',     top: 18, left: 28, width: 38, height: 36,
    labelKey: 'hotspot.face',     video: 'clip_05_face.mp4',
    endFrame: 'end_05_face.png',     subtitleKey: 'sub.face',
    affordance: 'ripple', affordanceX: 50, affordanceY: 50 },
];

const CLIMAX_VIDEO = 'clip_06_climax.mp4';
const CLIMAX_END_FRAME = 'end_06_climax.png';
const CLIMAX_SUBTITLE = "i'm logging off for a while.";
